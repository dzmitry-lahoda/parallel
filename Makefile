...
init: submodules
	...
	curl --proto '=https' --tlsv1.2 -sSf https://sh.rustup.rs | sh -s -- -y --default-toolchain nightly-2023-05-22 --component rust-src --component rustfmt --component clippy --target wasm32-unknown-unknown
